...
- The Architecture Decision Records under `docs/adr/` explain *why* features work the way they do. End-user pages should **not** cite ADR numbers or link individual ADRs; the single [Design decisions](../design-decisions.md) page is the only place that links out to them.
