...
VariableDecl      ::= ('const' | 'let' | 'var') 'scoped'? 'ref'? identifier TypeParamList? TypeClause? '=' Expression
                    ...
                    | 'var' 'scoped'? identifier TypeClause                                  (* no initializer; binds the type's zero value — a sound empty
                                                                                                instance for map/slice/array/sequence, GS0520 for chan (ADR-0159) *)
