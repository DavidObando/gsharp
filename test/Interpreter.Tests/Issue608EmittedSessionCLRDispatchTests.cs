// <copyright file="Issue608EmittedSessionCLRDispatchTests.cs" company="GSharp">
...
/// <summary>
/// Issue #608: Emitted-session coverage for clr dispatch.
/// </summary>
public class Issue608EmittedSessionCLRDispatchTests
{
    /// <summary>
    ...
    /// </summary>
    [Fact]
    public void EmittedSession_DIMDispatchOnConcreteCLRType_Works()
    {
        var source = """
    ...
    /// </summary>
    [Fact]
    public void EmittedSession_FieldSatisfiesGetterOnlyPropertyContract_GetterReadsField()
    {
        var source = """
            import GSharp.Interpreter.Tests.ProbeRef
            import System
    ...
    /// </summary>
    [Fact]
    public void EmittedSession_FieldSatisfiesReadWritePropertyContract_BothAccessorsWork()
    {
        var source = """
            import GSharp.Interpreter.Tests.ProbeRef
            import System
    ...
    /// emitted session. Tests that MemberLookup.SafeGetMethodIncludingSelfAndInterfaces
    /// finds the Dispose method correctly.
    /// </summary>
    [Fact]
    public void EmittedSession_BasicIDisposableInUsingLet_StillWorks()
    {
