// <copyright file="AttributeEmittedSessionTests.cs" company="GSharp">
...
{
    [Fact]
    public void EmittedSession_Accepts_Obsolete_Annotation_On_Function()
    {
    ...
    [Fact]
    public void EmittedSession_Reports_Obsolete_Warning_At_Call_Site_And_Continues()
    {
    ...
    [Fact]
    public void EmittedSession_Reports_Obsolete_Error_When_IsError_Is_True()
    {
    ...
    [Fact]
    public void EmittedSession_Rejects_Reserved_CompilerGenerated_Attribute()
    {
    ...
    [Fact]
    public void EmittedSession_Accepts_AttributeSugar_Class_Declaration()
    {
    ...
    [Fact]
    public void EmittedSession_Reports_Obsolete_Warning_On_Struct_Field_Read()
    {
