// <copyright file="Issue738SwitchArmFlowEmittedSessionTests.cs" company="GSharp">
...
/// <summary>
/// Issue #738: Emitted-session coverage for switch arm flow.
/// </summary>
public class Issue738SwitchArmFlowEmittedSessionTests
{
    [Fact]
