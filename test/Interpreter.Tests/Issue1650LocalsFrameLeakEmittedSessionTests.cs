// <copyright file="Issue1650LocalsFrameLeakEmittedSessionTests.cs" company="GSharp">
...
/// <summary>
/// Issue #1650: Emitted-session coverage for locals frame leak.
/// </summary>
public class Issue1650LocalsFrameLeakEmittedSessionTests
{
    [Fact]
