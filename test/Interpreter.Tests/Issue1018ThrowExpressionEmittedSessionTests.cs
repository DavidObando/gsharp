// <copyright file="Issue1018ThrowExpressionEmittedSessionTests.cs" company="GSharp">
...
/// <summary>
/// Issue #1018: Emitted-session coverage for throw expression.
/// </summary>
public class Issue1018ThrowExpressionEmittedSessionTests
{
    [Fact]
