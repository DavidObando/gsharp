// <copyright file="Issue759StructMarshallingEmittedSessionTests.cs" company="GSharp">
...
{
    [Fact]
    public void Blittable_SequentialLayout_Struct_Binds_And_Runs_In_EmittedSession()
    {
        var source = """
    ...
    [Fact]
    public void Explicit_StructLayout_With_FieldOffsets_Binds_In_EmittedSession()
    {
        var source = """
            import System.Runtime.InteropServices
    ...
    [Fact]
    public void Auto_LayoutKind_Reports_GS0346_Under_EmittedSession()
    {
        var source = """
            import System.Runtime.InteropServices
    ...
    [Fact]
    public void FieldOffset_On_Sequential_Reports_GS0348_Under_EmittedSession()
    {
        var source = """
            import System.Runtime.InteropServices
    ...
    [Fact]
    public void NonBlittable_Struct_In_PInvoke_Reports_GS0349_Under_EmittedSession()
    {
        var source = """
            import System.Runtime.InteropServices
