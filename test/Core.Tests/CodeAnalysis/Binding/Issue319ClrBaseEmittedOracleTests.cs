// <copyright file="Issue319ClrBaseEmittedOracleTests.cs" company="GSharp">
...
/// <summary>
/// Issue #319: Emitted-oracle coverage for clr base.
/// </summary>
public class Issue319ClrBaseEmittedOracleTests
{
    [Fact]
    public void InitConstructor_ChainingToClrException_EmittedOracleObservesBaseMessage()
    {
...
";
    ...
    [Fact]
    public void PrimaryConstructor_ChainingToClrException_EmittedOracleObservesBaseMessage()
    {
...
";
    ...
    [Fact]
    public void NonExceptionClrBase_PrimaryCtor_EmittedOracleObservesBaseState()
    {
