...
#pragma warning restore RS2008
    ...
    /// <c>// &lt;auto-generated&gt;</c> marker. Shared with the translator
    /// (<see cref="Cs2Gs.Translator.Loading.GeneratedSourceDetection"/>), which
    /// uses the same test to recognize a dropped partial-method part.
    /// </summary>
    private static bool HasAutoGeneratedHeader(SyntaxTree tree) =>
        Cs2Gs.Translator.Loading.GeneratedSourceDetection.HasAutoGeneratedHeader(tree);
