...
/// <see cref="CollectionInitializerExpressionSyntax"/>. The concrete
...
/// indexed entry <c>[key] = value</c>), and <see cref="MemberCollectionElementSyntax"/>
/// (an explicit receiver member <c>.Member: value</c>, ADR-0180).
/// </summary>
