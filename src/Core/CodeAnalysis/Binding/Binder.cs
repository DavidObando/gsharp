...
public sealed class Binder
{
    ...
    // callbacks; never back-references Binder. The two symbol-construction
    // `BindVariableDeclaration` overloads stay on Binder (used across
    // non-statement contexts) and are passed in as delegates.
...
#pragma warning restore SA1642
    ...
    public Binder(BoundScope parent, FunctionSymbol function)
    {
        ...
        statements = new StatementBinder(
            ...
            bindExpressionWithTargetType: (syntax, targetType) => BindExpression(syntax, targetType),
            bindTypeClause: BindTypeClause,
            bindLocalVariable: (identifier, isReadOnly, type) => BindVariableDeclaration(identifier, isReadOnly, type),
            bindLocalVariableWithAccessibility: (identifier, isReadOnly, type, accessibility) => BindVariableDeclaration(identifier, isReadOnly, type, accessibility),
            ...
            bindVariableDeclarationAttributes: (annotations, positionDescription) => BindAttributes(annotations, AttributeTargetKind.Field, VariableDeclarationAllowedTargets, positionDescription, System.AttributeTargets.Field),
            getCurrentFunction: () => this.function);
