...
public sealed class BoundReturnStatement : BoundStatement
{
    ...
    /// <param name="expression">The expression to return, or <c>null</c> for a
    /// bare <c>return</c>.</param>
    ...
    /// <param name="syntax">The originating syntax.</param>
    /// <param name="expression">The expression to return, or <c>null</c> for a
    /// bare <c>return</c>. When <paramref name="isRef"/> is true,
    ...
    /// <summary>
    /// Gets the expression to return, or <c>null</c> for a bare <c>return</c>
    /// in a function with no return value. The emitter and the bound-tree
    /// rewriter both test this before using it.
    /// </summary>
