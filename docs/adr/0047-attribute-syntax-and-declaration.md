...
remained relevant only while direct `Compilation.Evaluate` consumers and the
deprecated `gsi --engine evaluator` compatibility path remained. Phase 3c
removed the evaluator.
