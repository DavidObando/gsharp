...
| 24 | `IOperation.ChildOperations`, `Descendants()`, `DescendantsAndSelf()` | `BoundNode.ChildNodes`, `Descendants()`, `DescendantsAndSelf()`, with operation-tree children for lambdas, assignments and plain `is` | Exact — GSA0007 (#4436) |
