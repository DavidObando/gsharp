...
| RangeExpression | RangeExpressionSyntax |  |  | tools/cs2gs/corpus/grid/G05-Collections-Console/Constructs/RangeExpression.cs | https://github.com/DavidObando/gsharp/issues/4350 | Bracket slices and reusable `System.Range` values (including `^a..^b`) keep their native G# range syntax (ADR-0187). |
